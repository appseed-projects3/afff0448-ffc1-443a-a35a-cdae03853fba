...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-10 15:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/afff0448-ffc1-443a-a35a-cdae03853fba.git
$ cd afff0448-ffc1-443a-a35a-cdae03853fba
```
